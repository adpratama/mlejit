...
class Catalog extends CI_Controller
{
    ...
    {
        $villa = $this->M_Villa->detail_villa($id);
        $floor = $this->M_Villa->list_floor($villa['Id']);
        // $facility = $this->M_Villa->list_facility($floor['Id']);
        $data = [
            'title' => 'Catalog',
            'style' => 'layouts/_style',
            'pages' => 'villa/pages/details/v_details',
            'script' => 'layouts/_script',
            'villa' => $villa,
            'floor' => $floor,
            'photos' => $this->M_Villa->list_photo($villa['Id'])
        ];
