    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item  <?php if ($this->uri->segment(2) == 'invoicemart') echo 'active' ?>">Invoices</li>
            </ol>
        </nav>
    </div>
    <section class="section">
        <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/invoicemart/store/' . $invoice['no_invoice']) ?>" method="post" class="">
                                <div class="row g-2">
            ...
            ?>
                <div class="flash-data" data-flashdata="<?= $this->session->flashdata('message_name') ?>"></div>
                <div class="col-lg-12">
                    <form action="<?= base_url('admin/invoicemart/store') ?>" method="post" class="">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-3 text-end">
                                        <label for="keterangan" class="form-label">&nbsp;</label>
                                        <div class="mt-2">
                                            <a href="<?= base_url('admin/invoicemart') ?>" class="btn btn-sm btn-warning"><i class="bi bi-arrow-return-left"></i> Back</a>
