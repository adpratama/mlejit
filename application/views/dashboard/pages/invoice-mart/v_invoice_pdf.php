        ...
        <tbody>
            <tr>
                <td style="width: 400px">
                    <img src="<?= base_url(); ?>assets/img/mlejit_mart_crop.png" style="width: 200px;" alt="">
                </td>
                <td style="width: 400px;">
                    <table>
                        <tr>
                            <td>Tanggal</td>
                            <td>:</td>
                            <td style="text-align: right"><?= format_indo($invoice['tanggal_invoice']) ?></td>
                        </tr>
                        <tr>
                            <td>Nomor</td>
                            <td>:</td>
